...
public class PersonController {
	...
	@PutMapping(value = "/person/removeApartmentToPerson/{email}/{blockName}/{apartmentNo}", produces = "text/plain;charset=UTF-8")
	public String removeApartmentToPerson(HttpServletRequest request, @PathVariable("email") String email, @PathVariable("blockName") String blockName,@PathVariable("apartmentNo") Integer apartmentNo) {
		return messageSource.getMessage(personService.removeApartmentToPerson(email, blockName, apartmentNo), null, myLocaleResolver.resolveLocale(request));
	}
